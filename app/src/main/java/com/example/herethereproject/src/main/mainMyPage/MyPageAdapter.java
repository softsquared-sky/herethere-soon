...
import com.example.herethereproject.src.main.mainHome.MainHomePictureAdapter;
...
public class MyPageAdapter extends RecyclerView.Adapter<MyPageAdapter.HomeViewHolder> implements MainActivityPostsView {
    ...
    public MyPageAdapter(ArrayList<MainHomeItem> mHomeList){
